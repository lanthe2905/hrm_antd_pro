...
} from '@/models/phanCa.model'
import { request } from '@umijs/max'

const resource = '/api/v1/assign-shifts'
...
const nhomPhanCa = async (
  ...
  return await request<TongHopPhanCaResponse>(
    resource + '/' + 'users-assigned-and-not-assign',
    {
      params: params,
      method: 'GET',
    },
...
const danhSachDaPhanCa = async (params: {
  ...
  return await request<NhanVienDaPhanCaResponse>(
    resource + '/' + 'users-with-shits',
    {
      params: params,
      method: 'GET',
    },
