...
import type { NghiPhep, NghiPhepListResponse, NghiPhepsResponse } from '@/models/nghiPhep.model';
import paramtInterceptors from "@/util/paramtInterceptors";


const resource = '/api/leaves';
export const getList = async (params: any, options?: { [key: string]: any }) => {
